import {} from '@polymer/polymer/lib/mixins/gesture-event-listeners.js';
import * as Gestures from '@polymer/polymer/lib/utils/gestures.js';

const trackElement = function(trackElement, menuElement, callback) {

	Gestures.addListener(trackElement, "track", e => {
...
window.addSwipeAway = function(menuElement, callbackContainer, callbackMethod, additionalElement) {
